...
function $$SETUP_STATE(hydrateRuntimeState, basePath) {
  return hydrateRuntimeState({
    ...
    "packageRegistryData": [
      ...
      ["node", [
        ["npm:17.7.2", {
          "packageLocation": "./.yarn/unplugged/node-npm-17.7.2-9fb67bca5e/node_modules/node/",
          "packageDependencies": [
            ["node", "npm:17.7.2"],
            ["node-bin-setup", "npm:1.1.0"]
          ],
          "linkType": "HARD",
        }]
      ]],
      ["node-bin-setup", [
        ["npm:1.1.0", {
          "packageLocation": "./.yarn/cache/node-bin-setup-npm-1.1.0-822fb2c092-15d6448725.zip/node_modules/node-bin-setup/",
          "packageDependencies": [
            ["node-bin-setup", "npm:1.1.0"]
          ],
          "linkType": "HARD",
      ...
      ["node-json-db", [
        ["npm:1.5.0", {
          "packageLocation": "./.yarn/cache/node-json-db-npm-1.5.0-ca5d5f8bef-1c19539bc4.zip/node_modules/node-json-db/",
          "packageDependencies": [
            ["node-json-db", "npm:1.5.0"],
            ["mkdirp", "npm:1.0.4"]
          ],
